...
def on_IN1_button_clicked(event):
    f_IN1(amp_box.text, w_box.text, time_box.text, dt_box.text)
    print('Syg. prosto.')

def on_IN2_button_clicked(event):
    f_IN2(amp_box.text, w_box.text, time_box.text, dt_box.text)
    print('Syg. trójkąt.')

def on_IN3_button_clicked(event):
    f_IN3(amp_box.text, w_box.text, time_box.text, dt_box.text)
    print('Syg. harmon.')
